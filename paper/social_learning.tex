...
\WHILE{$g < generations$}
  ...
  \WHILE{$t < maxTimesteps$}
    \FOR{each $clique$ in $cliques$}
      ...
      \ENDFOR
    \FOR{each $agent$ in $clique$}
      \IF{Acceptable($agent.memory, agent.reward$)}
