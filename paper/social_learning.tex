...
Egalitarianism refers to any philosophy that advocates treating all individuals in a population as equals, regardless of such factors as background and status \cite{sep2009egalitarianism}. In hunter-gatherer societies, egalitarianism is a well-known technique for managing daily activities and organizing social structures\cite{boehm2001hierarchy}. It is hypothesized that this lack of hierarchy and strict maintenace of equality has been pivotal in the development of human society and in seperating humans from non-human animals\cite{erda1996egalitarianism}. 
...
\begin{figure}[t]
  ...
  \caption{The foraging domain. This domain is a foraging world in which agents gain fitness by consuming plants that they approach.  1) A piece of nutritious food which increases fitness. 2) A piece of poisonous food which decreases fitness. 3) An agent, the architecture of which is described in Figure \ref{fig:agent-architecture}.}
...
\begin{figure}
  ...
  \caption{Agents learning from social information without evolution, and agents evolving without social learning.  The evolution-free learning algorithm collapses after several generations, while neuroevolution alone converges to a stable but suboptimal solution.  Egalitarian social learning combines both methods.}
...
\begin{figure}
  ...
  \caption{The effects of Darwinian and Lamarckian evolution. Lamarckian learning is more effective than Darwinian and converges more rapidly, possibly because knowledge obtained by individual agents is useful and unchanging from one generation to the next.}
...
\begin{figure}
  ...
  \caption{Monocultural agents learning from the entire population and subcultural agents learning only from their subcultures.  Agents learning only from a subculture outperform agents learning from the entire population, converging to a much higher ultimate fitness. This effect may be related to the tendancy, discussed below, for subcultural learning to maintain diversity over time.}
...
\begin{figure}
  ...
  \caption{Change in the diversity of the velocity output by agents over time, for both monocultural and subcultural egalitarian learning.   Velocity converges quickly in both models, as there is rarely cause to move at any velocity below the maximum.}
  \label{fig:velocity}
\end{figure}
...
\begin{figure}
  ...
  \caption{Change in the diversity of agent outputs for orientation over time, for both monocultural and subcultural egalitarian learning. There are many possible good responses for change in orientation for any given inputs - tradeoffs between close, small rewards and distant, large rewards mean that exploring large portions of the search space can be fruitful.  Accordingly, diversity in response remains high for many evaluations.}
...
\begin{figure}
  ...
  \caption{Egalitarian learning, neuroevolution, and traditional student-teacher learning in the simple world. All strategies converge to solutions of similar quality, with egalitarian learning converging in the fewest evaluations.  The simplicity of the domain means that learning ends early.}
...
\begin{figure}
  ...
  \caption{Egalitarian learning, neuroevolution, and traditional student-teacher learning in the complex world.  In this more complex world characterized by higher dimensionality in agent input, egalitarian learning takes far fewer evaluations to arrive at a good solution, and converges to near-optimal solutions, while the other algorithms take longer to converge to weaker solutions.}
